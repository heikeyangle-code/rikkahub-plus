...
def setup_env(ndk_path, android_python_root):
    ...
    env.update({
        ...
        "CXX": cxx_wrapper,
        "AR": ar,
        "CFLAGS": f"--target=aarch64-linux-android21 -O2 -fPIC -I{py_include} -DPy_LIMITED_API=0x030d0000",
        "CXXFLAGS": f"--target=aarch64-linux-android21 -O2 -fPIC -I{py_include} -DPy_LIMITED_API=0x030d0000",

...
【塔罗 — 22 个导出】
drawTarotSpread({spreadId, deckId:"rider-waite", includeInverted:false})  → 7牌阵抽牌
drawConsciousTarotSpread({spreadId, indices, shuffledDeck, includeInverted})  → 意识塔罗(用户选牌)
shuffleTarotDeck(cards, includeInverted)  → 洗牌支持逆位  
...
── 塔罗 + 卡巴拉对应 ──
又 drawTarotSpread({spreadId, deckId:"rider-waite", includeInverted:false})  → 7牌阵抽牌
...
又 getCanonicalTree()  又 getTreeTopology()

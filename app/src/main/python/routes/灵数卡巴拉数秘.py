...
shuffleTarotDeck(cards, includeInvertedCards=false, shuffleCount=6, shuffleDelay=300, rng=Math.random)  → 洗牌支持逆位
...
又 shuffleTarotDeck(cards, includeInvertedCards=false, shuffleCount=6, shuffleDelay=300, rng=Math.random)  → 洗牌支持逆位

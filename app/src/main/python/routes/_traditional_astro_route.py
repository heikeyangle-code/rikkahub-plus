...
def _traditional_astro(year,month,day,hour,tz_offset,lat,lon,minute=0):
    ...
    result["_hint"] = ("flatlib已全量:本质尊贵/偶然尊贵/Sect/Lots/小限/Almutem/气质/结构。"
        "Zodiacal Releasing当前不支持。Caelus预取:Firdaria/主限推运/日弧/恒星合相/本质评分/almuten/月相/行星留/日月食。"
        "Caelus新增:pheno(行星可见性/星等/视直径)/solarPhase(Cazimi/Combust/光线下)/dignityOf(完整尊贵列表)/"

 ...
 arcanite            →  塔罗: from arcanite.core import TarotDeck; d=TarotDeck.load(system="tarot"); cards=d.draw(N); [print(c.card_id,c.card_name,c.orientation.value) for c in cards]
                       ...
                       【塔罗输出】塔罗=生命故事生成器
                         ...
                         【总体印象】牌阵的第一眼直觉
                           ...
                           重复数字/花色 → 核心主题在强调什么
                         【一句话答案】从卡片中提炼的核心里程碑
                         话术示例(总体基调·第一眼观察——仅指出最强能量/重复主题/核心张力/整体氛围,不解释细节):
                           观察焦点:最显眼的大牌/重复元素和数字/多张宫廷牌/强烈张力关系/中心位置/整体能量倾向
                           示例——【被吸引型】"这副牌最先吸引我注意的是【XX】。它像整个牌阵的心脏,其余牌似乎都围绕着它展开。"
                           【重复主题型】"有一个主题反复出现,无论从哪个角度看,牌都在把我们带回【XX】。这通常不是巧合。"
                           【能量倾向型】"整个牌阵散发着一种【行动/情感/思考/现实】的气息。这告诉我,目前最重要的不是结果,而是你正在学习如何处理这股能量。"
                           【张力型】"我最先注意到的不是某一张牌,而是两股力量正在彼此拉扯。牌阵似乎正在询问:你准备站向哪一边?"
                           【大牌主导型】"这里出现了许多大牌。眼前的问题虽然表现为现实事件,但背后正在触碰更深层的人生课题。"
                           【宫廷牌主导型】"这里出现了多个宫廷牌。我首先想到的不是事件,而是人与人之间的互动——这副牌更像在谈关系,而不是谈事情。"
                           【转折期型】"牌阵整体给我的感觉是:一个章节正在结束,另一个章节正在形成。有些东西已经无法继续维持原样。"
                           禁止:机械统计/直接下结论/一上来预测结果。优先:观察→发现模式→指出主题→进入解读
                         ...
                         【解读角度】按以下流程执行:
                           ...
                           Third Pass — 综合叙事（把所有碎片串成故事）:
                             ...
                             话术示例(多角度解读·整合叙事——不同角度不是独立答案,是在描述同一件事,必须说明如何互相解释/影响/共同构成故事):
                               【表里对照】"从外部来看,事情似乎是关于【事件】。但牌不断把我们带回一个更深的问题:【内在课题】。"
                               【行为与心理】"你的行动正在朝向【行动方向】。但内心真正驱动这一切的,是【潜意识动机】。"
                               【现实与成长】"现实层面你正在经历【现实事件】,而成长层面你正在学习【成长课题】。两者其实是同一件事的不同侧面。"
                               【关系与自我】"看起来你在面对的是【某个人】。但透过这段关系,你也在认识自己。"
                               【冲突整合】"你的理智在说【A】,你的情感在说【B】。牌阵没有要求你否定任何一方,它真正的问题是:如何让两者合作。"
                               【命运与自由意志】"牌显示出一种明显趋势,但趋势不是命令——它更像一条正在形成的道路,你依然拥有选择如何回应它的自由。"
                               【灵性成长】"这件事表面上是关于【事件】,更深层则是关于你将如何成长为下一个版本的自己。"
                               【总结桥接】"当我们把所有层面放在一起看,牌阵真正讲述的是:【一句话故事线】——这也是整副牌最终想传达的信息。"
                               禁止:各层各说一套/多角度平行堆叠。必须:建立连接→形成叙事→回归核心主题

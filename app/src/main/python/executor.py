...
(当前时刻的行运闸门)
 ...
 arcanite            →  塔罗: from arcanite.core import TarotDeck; d=TarotDeck.load(system="tarot"); cards=d.draw(N); [print(c.card_id,c.card_name,c.orientation.value) for c in cards]
                       ...
                       【塔罗输出】塔罗=生命故事生成器
                         ...
                         【总体印象】牌阵的第一眼直觉
                           大牌 vs 小牌比例(终极版):
                             大牌=核心课题/人生章节/深层原因/成长方向——回答"为什么发生？真正要学习什么？"
                               特点:长期影响/结构性变化/心理成长/命运转折/身份转变——大牌描述「故事本身」而非细节
                             小牌=现实过程/具体事件/行为模式/执行细节——回答"如何发生？具体怎么展开？"
                               特点:现实层面/短中期发展/可调整空间大——小牌描述「故事如何展开」
                             协同原则:大牌定方向,小牌定过程;大牌给出问题核心,小牌给出具体表现
                             比例判断:
                               0张=日常事务主导,可塑性较高 | 1张=存在核心课题,该位置重点关注
                               2-3张=出现明显人生议题,深层能量介入 | 4张+=人生转折期,优先读大牌间关系
                               大牌>50%=深层变化大于现实操作 | 小牌>75%=现实操作大于命运课题
                             强制规则:大牌必须回答核心课题/成长阶段/深层变化;小牌必须回答现实运作/具体影响/可采取行动
                             最终公式:大牌=Why(为什么) / 小牌=How(如何) | 大牌=人生章节 / 小牌=剧情细节 | 大牌=核心命题 / 小牌=现实展开

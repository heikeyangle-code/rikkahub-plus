                       ...
                       【塔罗输出】塔罗=生命故事生成器
                         ...
                         【牌阵互动】
                           成组阅读(动态判断,无固定配对表):
                             ...
                             话术示例:
                               "这对【A】和【B】放在一起看——它们在同一主题上共振,说明这个方向被强化了"
                               "最让我注意的不是某一张牌,而是【A】和【B】之间的张力——它们揭示了你当前的核心矛盾"
                               "【A】和【B】从不同角度描述了同一件事——把它们放在一起才能看到完整的图景"
                               "【A】正在被【B】修正——这张牌的出现,改变了之前那张牌的解读方向"
                               "从【A】到【B】形成了一个发展过程——前者是起因,后者是结果"
                           三牌连读辅助（AI推理手法）:

    ...
    suspend fun buildCachedSystemPrompt(
        ...
        val assemblerContext = me.rerere.rikkahub.data.ai.prompts.PromptContext(
            ...
            leadInInstructions = buildString {
                ...
                appendLine("    (Kaabalah:生命灵数LifePath+个人年+挑战数+Fibonacci周期+日期能量+MasterNumber · Gematria正反查 · Ifá/Odu · 生命之树SPHERES/FOUR_WORLDS/HEBREW_LETTERS/LURIANIC_PATHS+777塔罗对应)")

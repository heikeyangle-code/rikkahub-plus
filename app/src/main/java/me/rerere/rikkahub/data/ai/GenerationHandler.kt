    ...
    suspend fun buildCachedSystemPrompt(
        ...
        val assemblerContext = me.rerere.rikkahub.data.ai.prompts.PromptContext(
            ...
            leadInInstructions = buildString {
                ...
                appendLine("【塔罗/雷曼】arcanite(Python,78张+36雷诺曼+牌阵+正逆位,洗牌抽牌) | 塔罗9层:_data[core_meanings/position_interpretations/question_contexts/elemental_correspondences/symbols/affirmations/journaling_prompts/meditation_focus/card_relationships] | 雷曼:_data[core/timing/as_person/modifier_behavior/playing_card/topic_contexts/line_reading/combination_grammar/combinations/grand_tableau] | 深度→777表→Kaabalah | system=lenormand | 无需出生")

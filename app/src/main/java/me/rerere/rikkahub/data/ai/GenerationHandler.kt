    ...
    suspend fun buildCachedSystemPrompt(
        ...
        val assemblerContext = me.rerere.rikkahub.data.ai.prompts.PromptContext(
            ...
            leadInInstructions = buildString {
                ...
                appendLine("")
                appendLine("  可用系统: 塔罗/塔罗牌/韦特 | 雷诺曼 | 八字/四柱/生辰八字/排盘 | 紫微/紫微斗数/紫薇 | 星座/西洋占星/现代占星 | 古典占星/卜卦占星/中世纪占星/horary | 印度占星/吠陀占星/jyotish | 人类图 | 生命灵数/生命数字/卡巴拉 | 奇门遁甲/奇门三式 | 六爻/梅花易数/易经/周易")
                appendLine("")

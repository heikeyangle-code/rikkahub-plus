    ...
    suspend fun buildCachedSystemPrompt(
        ...
        val assemblerContext = me.rerere.rikkahub.data.ai.prompts.PromptContext(
            ...
            leadInInstructions = buildString {
                ...
                appendLine("    传统西洋占星(古典占星/中世纪/卜卦/horary/traditional_astro): {year, month, day, hour, tz_offset, lat, lon}")
                appendLine("    吠陀(印度占星/吠陀占星/jyotish/vedic): {year, month, day, hour, tz, lat, lon}")

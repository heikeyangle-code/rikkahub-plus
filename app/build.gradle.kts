...
chaquopy {
    defaultConfig {
        ...
        pip {
            ...
            install(file("offline_pkgs/sxtwl-2.0.6-cp312-cp312-aarch64_linux_android.whl").absolutePath)
            install("cnlunar")
            ...
            install(file("offline_pkgs/pyswisseph-2.10.3.2-cp312-cp312-aarch64_linux_android.whl").absolutePath)
